...
EuclideanParamErrorSized<kParamDim>::EuclideanParamErrorSized(const Eigen::Matrix<double, kParamDim, 1> & measurement,
...
// Set the information.
template<int kParamDim>
void EuclideanParamErrorSized<kParamDim>::setInformation(const information_t & information) {
...
template<int kParamDim>
bool EuclideanParamErrorSized<kParamDim>::Evaluate(double const* const * parameters,
...
template<int kParamDim>
bool EuclideanParamErrorSized<kParamDim>::EvaluateWithMinimalJacobians(
