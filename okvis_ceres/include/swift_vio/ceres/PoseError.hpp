...
/**
 * @file PoseError.hpp
 * @brief Header file for the PoseError class with PoseLocalParameterizationSimplified.
 * @author
 */

#ifndef INCLUDE_SWIFT_VIO_POSEERROR_HPP_
#define INCLUDE_SWIFT_VIO_POSEERROR_HPP_
...
class PoseError : public ::ceres::SizedCostFunction<6 /* number of residuals */,
    7 /* size of first parameter */>, public okvis::ceres::ErrorInterface {
 public:
...
#endif /* INCLUDE_SWIFT_VIO_POSEERROR_HPP_ */
